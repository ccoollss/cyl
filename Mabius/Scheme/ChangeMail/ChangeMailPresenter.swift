...
protocol ChangeMailPresenterInput {
...
protocol ChangeMailPresenterOutput: class {
...
class ChangeMailPresenter: ChangeMailPresenterInput {
    
    private weak var output: ChangeMailPresenterOutput?

    init(output: ChangeMailPresenterOutput) {
        self.output = output
    }
